...
import com.project.booksphere.bo.custom.impl.ManagerHomePageBOImpl;
...
public class ManagerHomePageController implements Initializable {
    ...
    @FXML
    private Button managePromotion;
...
//    private final UserDAO userDAO = new UserDAOImpl();
    ...
    private final ManagerHomePageBo managerHomePageBo = (ManagerHomePageBo) BOFactory.getInstance().getBO(BOFactory.BOType.MANAGER_HOMEPAGE);
    ...
    void navigateDashboard(ActionEvent event) {
        navigateTo("/view/DashboardManager.fxml");
    }

    @FXML
    void navigateToCustomerPage(ActionEvent event) {
        navigateTo("/view/ManageCustomer.fxml");
    }

    @FXML
    void navigateToEmployeePage(ActionEvent event) {
        navigateTo("/view/ManageEmployee.fxml");
    }
    ...
    @FXML
    void navigateToPromotionPage(ActionEvent event) {
    ...
    void navigateToSupplierPage(ActionEvent event) {
        navigateTo("/view/ManageSupplier.fxml");
    }
    ...
    public void setName(String id) throws SQLException {
        String getName = managerHomePageBo.getEmployeeName(id);
        lblUser.setText(getName);
        System.out.println(getName);
        String userId = managerHomePageBo.getUserID(id);
    ...
    private void setDashboard() throws IOException {
        ownerBodyPane.getChildren().clear();
        AnchorPane load =  FXMLLoader.load(getClass().getResource("/view/DashboardManager.fxml"));
        load.prefHeightProperty().bind(ownerBodyPane.widthProperty());
        load.prefHeightProperty().bind(ownerBodyPane.heightProperty());
        ownerBodyPane.getChildren().add(load);
    }
