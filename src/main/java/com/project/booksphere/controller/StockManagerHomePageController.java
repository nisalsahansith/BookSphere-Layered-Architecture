...
public class StockManagerHomePageController implements Initializable {
...
//    private final UserDAO userDAO = new UserDAOImpl();
    ...
    void navigateDashboard(ActionEvent event) {
        navigateTo("/view/DashboardStockManager.fxml");
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        private void setDashboard() throws IOException {
            ...
            AnchorPane load =  FXMLLoader.load(getClass().getResource("/view/DashboardStockManager.fxml"));
